...
fetch() {
  ...
  curl -fsSL -o "$f" "https://cdn.jsdelivr.net/gh/t-orz/keiba-mystery-viewer@${BRANCH}/tools/yokuumakun_race_day_evening_functional_test/$f"
}

echo "INFO: race-day evening functional test bootstrap root=$ROOT branch=$BRANCH"
